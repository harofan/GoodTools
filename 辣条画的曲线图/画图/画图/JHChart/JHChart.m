...
//        self.xAndYLineColor = [UIColor whiteColor];
...
//改的.......
- (void)drawXLineWithContext:(CGContextRef )context andStarPoint:(CGPoint )start andEndPoint:(CGPoint)end andIsDottedLine:(BOOL)isDotted andColor:(UIColor *)color{
